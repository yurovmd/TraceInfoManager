...
public enum TraceInfoManager {
    ...
    public actor QueueManagerImpl: QueueManager {
        ...
        public func allocateQueueIndex() async throws -> UInt {
        ...
        public func incrementSent(queueIndex: UInt) async throws {
        ...
        /// - Parameter queueIndex: The index of the queue.
        public func incrementSucceeded(queueIndex: UInt) async throws {
            guard queueIndex < maxConcurrent else {
                throw QueueManagerError.invalidQueueIndex
            }
        ...
        public func getTraceInfo(queueIndex: UInt) async -> TraceInfo? {
        ...
        public func deallocateQueueIndex(queueIndex: UInt) async {
